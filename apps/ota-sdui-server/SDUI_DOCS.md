...
_Example:_ The **Loyalty** tab uses the generic screen engine to render a custom banner and notice without requiring a specific `loyalty.tsx` file in the mobile codebase.
