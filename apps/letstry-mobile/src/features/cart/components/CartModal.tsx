...
const CartModal = () => {
  ...
  const { addToCart, updateCartItem, removeFromCart, isUpdating, isRemoving } =
    useCartMutations();
  ...
  const handleUpdateQuantity = (id: string, qty: number) => {
    ...
    if (qty <= 0) {
      ...
      updateCartItem({
        variables: { input: { productId: id, quantity: qty } },
      });
    }
  };
          ...
          <>
            ...
            <View style={styles.footer}>
              <View style={styles.footerContent}>
                ...
                <TouchableOpacity
                  style={[styles.checkoutBtn, sduiConfig?.checkoutBtnStyle]}
                  activeOpacity={0.8}
                  onPress={() => {
                    closeCart();
