...
import {
  ...
  GET_GUEST_SHIPMENT_TRACKING,
} from "../../src/lib/graphql/order";
  ...
  return (
    <View style={tStyles.entry}>
      ...
      <View style={tStyles.content}>
        ...
        {entry.remarks ? (
          <Text style={tStyles.remarks}>{entry.remarks}</Text>
        ) : null}
      </View>
    </View>
  );
        ...
        return (
          <View key={step.key} style={stepStyles.stepRow}>
            ...
            {idx > 0 && (
              <View
                style={[
                  ...
                  { backgroundColor: done || active ? "#38A169" : "#DDD" },
                ]}
              />
            )}
            <View style={stepStyles.iconWrap}>
              ...
              >
                <Ionicons name={step.icon as any} size={18} color={color} />
              </View>
            </View>
            <Text
              style={[
...
export default function OrderDetailScreen() {
  ...
  const trackingQuery = isAuthenticated
    ? GET_SHIPMENT_TRACKING
    : GET_GUEST_SHIPMENT_TRACKING;
  ...
  const statusColor =
    STATUS_COLOR[order.orderStatus] || theme.colors.text.muted;
  ...
  const expectedDate =
    shipment?.revisedExpectedDeliveryDate || shipment?.expectedDeliveryDate;
          ...
          <View style={styles.section}>
            <View style={styles.sectionRow}>
              ...
              {shipment?.trackingLink && (
                <TouchableOpacity
                  onPress={() => Linking.openURL(shipment.trackingLink)}
                >
            ...
            {shipment?.currentStatusDescription && (
              <View style={styles.currentStatusBox}>
                ...
                />
                <Text
                  style={[styles.currentStatusText, { color: statusColor }]}
                >
                  {shipment.currentStatusDescription}
                </Text>
              </View>
        ...
        <View style={styles.section}>
          ...
          {discount > 0 && (
            <View style={styles.priceRow}>
              ...
              <Text style={[styles.priceValue, { color: "#38A169" }]}>
        ...
        {order.payment && (
          <View style={styles.section}>
            ...
            <View style={styles.infoRow}>
              ...
              <Text
                style={[
                  ...
                  {
                    color:
                      PAYMENT_STATUS_COLORS[order.payment.status] || "#333",
                  },
                ]}
              >
            ...
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>
                ₹
                {parseFloat(order.payment.amount || "0").toLocaleString(
                  "en-IN",
                )}
              </Text>
            </View>
