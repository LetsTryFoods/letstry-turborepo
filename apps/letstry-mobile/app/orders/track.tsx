  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(
        `https://apiv3.letstryfoods.com/shipments/lookup?q=${encodeURIComponent(field.value)}`,
      );
      ...
      if (response.ok && data.awbNumber) {
        ...
        Alert.alert(
          "No Shipment Found",
          data.message || "No shipment found for the provided details.",
        );
      }
    } catch (error) {
        ...
        >
          <View style={styles.searchSection}>
            ...
            <Text style={styles.introSub}>
              Enter any one of the details below to find your order status.
            </Text>
          </View>
