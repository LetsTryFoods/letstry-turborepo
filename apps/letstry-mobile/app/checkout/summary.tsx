...
import {
  ...
  clearIdempotencyKey,
} from "../../src/lib/utils/idempotency";
    ...
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>
          Loading current delivery charges...
        </Text>
      </View>
    );
  }
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.deliveryEstimate}>
            ...
            <Text style={styles.deliveryEstimateText}>
              ...
              <Text style={styles.deliveryEstimateBold}>5–6 days</Text>
            </Text>
          </View>
        </View>
        ...
        <View style={styles.secureNote}>
          ...
          <Text style={styles.secureNoteText}>
            Payments are secured via Zaakpay. Your data is encrypted &
            protected.
          </Text>
        </View>
      </ScrollView>
