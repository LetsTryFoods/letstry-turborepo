...
const HomeProductCard = ({ product, onPress, onAddToCart, onRemoveFromCart }) => {
  ...
  // 2. Updated imageSource to include caching properties for FastImage
  const imageSource =
        ...
        <View style={styles.card}>
          ...
          <View>
            <View style={styles.imageWrapper}>
              {/* 3. Replaced Image with FastImage and updated resizeMode prop */}
              <FastImage
                source={imageSource}
                style={styles.image}
