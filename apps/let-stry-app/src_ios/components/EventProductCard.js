...
//   TouchableOpacity,
//   StyleSheet,
//   Pressable, // Replaced TouchableHighlight with Pressable
//   Animated,
//   I18nManager,
// } from "react-native";
...
// /**
//  * Lightweight shimmer just for the tag background.
//  */
...
// // --- MAIN CARD ---
// const EventProductCard = ({ product, onPress, onAddToCart, onRemoveFromCart }) => {
//   const [imageError, setImageError] = useState(false);
//   const { addItemToCart, removeItemFromCart, getItemQuantity } = useCart();
//   const quantity = getItemQuantity(product?.id);

//   // --- NEW: Animation value for the card press effect ---
//   const scaleAnim = useRef(new Animated.Value(1)).current;

//   // --- MODIFICATION 1: Check for the out of stock flag from the API ---
//   const isOutOfStock = product?.isOutOfStock === true;

//   const handlePressIn = () => {
//     // --- MODIFICATION 2: Prevent animation if out of stock ---
//     if (isOutOfStock) return;
//     // Animate to a smaller size on press
...
//     // --- MODIFICATION 3: Prevent animation if out of stock ---
//     if (isOutOfStock) return;
//     // Animate back to original size on release
//     Animated.spring(scaleAnim, {
//       toValue: 1,
...
//      // --- MODIFICATION 4: Prioritize showing the "Out of Stock" tag ---
//     if (isOutOfStock) {
//       return (
...
//         case "Bought Earlier": // New Tag
//           return styles.boughtEarlierTag;
//         case "Gifting": // New Tag
...
//   return (
//     // --- MODIFICATION 5: Disable press and apply dull style if out of stock ---
...
//             {/* --- MODIFICATION 6: Show "Out of Stock" button or regular actions --- */}
//             {isOutOfStock ? (
...
//               </View>
//             ) : quantity > 0 ? (
//               // --- THE ONLY CHANGE IS HERE: View was changed to Pressable ---
...
//   // --- MODIFICATION 7: Add styles for out of stock state ---
//   outOfStockCard: {
//     opacity: 0.6,
//   },
//   outOfStockTag: {
...
//   tagContainer: {
//     position: "absolute",
//     top: hp("1.5%"), // Changed from 10 to move it down onto the image area
//     left: 0,
//     zIndex: 1, // Added to ensure the tag is layered on top of the image
//     minWidth:  wp("20%"),
//     height: hp("2.5%"),
//     paddingHorizontal: 8,
...
//   },
//   newLaunchTag: {
//     backgroundColor: "#B8EEB3", // Updated color
//   },
//   boughtEarlierTag: { // New style
//     backgroundColor: "#F4C09D",
//   },
//   giftingTag: { // New style
...
//   const ProductTag = ({ tagData }) => {
//     // --- CHANGE IS HERE: Removed the if(isOutOfStock) condition ---
//     const tagText = useMemo(
//       () => (Array.isArray(tagData) && tagData.length > 0 ? tagData[0] : null),
//       [tagData]
//     );
