...
// // --- Gradient Header with pen button at right ---
// const GradientHeader = ({ title, onBack, onEditPress, canEdit }) => (
//   <LinearGradient
...
//             <Ionicons name="create-outline" size={RFValue(20)} color="#222" />
//           </TouchableOpacity>
//         )}
//       </View>
//     </View>
...
//   // Clear error for a specific field when changed
...
//         errors.dob = "Please enter DOB in YYYY-MM-DD format.";
//         hasError = true;
//       } else {
...
//       errors.general = "Please enter some information to update.";
//       hasError = true;
//     }
...
//         email: "",
//         dob: "",
//         general: error?.message || "Could not update profile. Try again."
//       });
//       console.error(error);
//     } finally {
//       setUpdating(false);
...
//   // Header pen handler
//   const handleEditPress = () => { setEditing(true); setFieldErrors({ name: "", email: "", dob: "", general: "" }); };
...
//   // Dynamic input color for editable/not-editable state
//   const getInputColor = () => (editing && !updating ? "#222" : "#888");
...
//               {/* General error */}
//               {fieldErrors.general ? (
//                 <Text style={styles.fieldError}>{fieldErrors.general}</Text>
//               ) : null}
//               {/* Full Name */}
...
//                     style={[styles.input, { color: getInputColor() }]}
//                     value={dob}
//                     onChangeText={t => { setDob(t); clearFieldError("dob"); }}
...
//                     style={{ paddingHorizontal: 4, opacity: editing ? 1 : 0.5 }}
//                   >
//                     <Icon
//                       name="calendar-today"
//                       size={RFValue(18)}
//                       color={editing ? "#0C5273" : "#888"}
//                     />
//                   </TouchableOpacity>
//                 </View>
//                 {fieldErrors.dob ? (
...
// const GradientHeader = ({ title, onBack, onEditPress, canEdit, insets }) => (
//   <LinearGradient
//     colors={["#F2D377", "#F5F5F5"]}
//     start={{ x: 0, y: 0 }}
//     end={{ x: 0, y: 1 }}
...
//   return (
//     // ✅ FIX: Root element ab normal View hai
//     <View style={{ flex: 1, backgroundColor: "#f5f5f5" }}>
//       <StatusBar translucent backgroundColor="transparent" barStyle="dark-content" />
//       {/* ✅ FIX: Header ko insets pass kiye */}
//       <GradientHeader
//         title="Profile"
//         onBack={() => navigation.goBack()}
//         onEditPress={handleEditPress}
...
//       {/* ✅ FIX: Content ke liye SafeAreaView use kiya hai */}
//       <SafeAreaView style={styles.safeArea}>
//         <View style={styles.container}>
//           {loading ? (
//             <ActivityIndicator size="large" color="#0C5273" style={{ marginTop: hp("20%") }} />
