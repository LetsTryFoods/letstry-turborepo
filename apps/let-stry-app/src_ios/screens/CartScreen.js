...
//   Modal,
// } from "react-native";
// // ✅ FIX: Added useSafeAreaInsets to handle the notch/status bar area correctly.
...
// // ✅ FIX: Replaced the old header with the one from CategoriesScreen for consistency.
// const GradientHeader = ({ title = "Categories", onBack, onSearch, insets }) => (
//   <LinearGradient
//     colors={["#F2D377", "#F5F5F5"]}
//     start={{ x: 0, y: 0 }}
//     end={{ x: 0, y: 1 }}
//     style={headerStyles.gradient} // Gradient has no vertical padding itself.
//   >
//     {/* All content is inside this View, which gets top padding from the insets. */}
...
// // ✅ OPTIMIZATION: Created a memoized CartItem component.
// // This prevents items from re-rendering unless their specific data changes.
...
//   // ✅ FIX: Get safe area insets to pass to the new header.
...
//   // ✅ OPTIMIZATION: Wrapped handlers in useCallback to maintain reference stability for memoized components.
...
//   // ✅ OPTIMIZATION: Memoized the FBT recommendations section to prevent re-rendering.
...
//   // ✅ OPTIMIZATION: Memoized the Coupon section to prevent re-rendering.
...
//   // ✅ FIX ADDED: This function handles closing the modal and navigating to the Add Address screen.
//   const handleNavigateToAddAddress = () => {
//     setAddressModalVisible(false); // This will close the modal
//     // Navigate to the add address screen
//     setTimeout(() => {
//         navigation.navigate("AddAddressScreen");
//     }, 150); // A small delay helps the closing animation look smooth
//   };
...
//               ) : (
//                 <CardSection>
//                    {/* ✅ OPTIMIZATION: Using the new memoized CartItem component. */}
//                    {cartItems.map((item) => (
//                       <CartItem
...
//                               <Text allowFontScaling={false} adjustsFontSizeToFit={true}  style={styles.infoBoxText}>GST on Handling charge ({billCharges.gstPercentage}%)</Text>
//                               <Text allowFontScaling={false} adjustsFontSizeToFit={true} numberOfLines={1} style={styles.infoBoxText}>₹{gstAmount.toFixed(2)}</Text>
//                             </View>
//                           </View>
//                         )}
//                       </View>
...
//                     </TouchableOpacity>
//                   </View>
//                   {/* ✅ FIX ADDED: Pass the navigation function as a prop. */}
//                   <AddressBookModal 
...
// // ✅ OPTIMIZATION: Created a memoized CartItem component.
// // 🛑 MODIFICATION START: Replaced TouchableOpacity with View to make product item non-clickable.
// const CartItem = React.memo(({ item, onAddItem, onRemoveItem, onNavigate }) => (
//     <View style={styles.cartItem}>
//       {/* 🛑 CHANGE: Replaced TouchableOpacity with View and removed onPress/activeOpacity */}
//       <View
//         style={styles.productContainer}
//         // activeOpacity={0.8} // Removed
//         // onPress={() => onNavigate(item.id)} // Removed
//       >
//         <View style={styles.imageContainer}>
//           <Image
//             source={{ uri: item.imageUrl }}
