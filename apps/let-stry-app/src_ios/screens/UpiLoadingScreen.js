...
// const POLLING_INTERVAL_MS = 3000; // Moved hardcoded value to a constant

// export default function UpiLoadingScreen() {
//   const navigation = useNavigation();
//   const route = useRoute();
//   const { idToken } = useAuth();
//   const { orderId, timeout } = route.params || {};
...
//   // --- FIX: Add a ref to prevent multiple navigations ---
...
//   // --- FIX: Check the isNavigatingRef flag before navigating ---
//   useEffect(() => {
//     if (timeLeft === 0 && !isNavigatingRef.current) {
//       isNavigatingRef.current = true; // Set the flag
//       navigation.replace("PaymentFailModal", {
...
//       if (!orderId || isNavigatingRef.current) return; // <-- Check the flag

//       try {
//         const result = await checkUpiStatus(orderId, idToken);
//         if (isNavigatingRef.current) return; // Double-check after await
