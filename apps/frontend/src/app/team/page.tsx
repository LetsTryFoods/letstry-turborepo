      ...
      <main className="min-h-screen bg-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
          ...
          <p className="text-base sm:text-lg text-gray-700 leading-relaxed mb-10 max-w-3xl">
            Let&apos;s Try Foods is built by a small team in Delhi who started
            this brand because they couldn&apos;t find Indian snacks made
            without palm oil for their own kids.
          </p>
...
function buildPersonSchema(author: Author) {
  return {
    ...
    hasCredential:
      author.credentials.length > 0 ? author.credentials : undefined,
