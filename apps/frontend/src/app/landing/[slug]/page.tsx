...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        seo?.ogDescription || seo?.metaDescription || page.description || "",
      url: pageUrl,
      images:
        seo?.ogImage || page.thumbnailUrl
          ? [
              {
                url: (seo?.ogImage || page.thumbnailUrl) as string,
                width: 1200,
                height: 630,
                alt: page.title,
              },
    ...
    twitter: {
      ...
      images:
        seo?.ogImage || page.thumbnailUrl
          ? [(seo?.ogImage || page.thumbnailUrl) as string]
          : [],
    },
  };
}
