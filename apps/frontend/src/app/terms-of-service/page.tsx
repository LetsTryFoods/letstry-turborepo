    ...
    <div className=" bg-white px-[15px] md:px-[30px] lg:px-[45px] py-4 text-[#000000] w-full">
      ...
      <section className="space-y-6 leading-snug text-justify lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          is owned and operated by Earth Crust company. Throughout the site, the
          terms "we," “us” and “our” refer to Earth Crust company. The website
          including all the literature and information, tools, and services
          available from the site to you the user, is conditioned upon your
          acceptance of all terms, conditions, policies, and notices stated here
          and is offered to you by Earth Crust company.
        </p>
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          conditions of this agreement, you may choose not to access the website
          or use any of its services. If these Terms of Service are considered
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          primary, more accurate and complete, or more timely sources of
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          reserve the right to modify or discontinue the Service (or any part or
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          orders that use the same billing and/or shipping address. If we make a
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          conditions of any kind and any endorsement. We shall have no liability
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          or websites, or any other materials, products, or services of third
          parties.
        </p>
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          email, by post, or otherwise (collectively, ‘comments’), you agree
          ...
          that you forward to us. We are and shall be under no obligation:
          <br />
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          <ul className="list-disc ml-0 my-2">
            ...
            <li>
              To spam, phish, pharm, pretext, crawl, scrape, or for any obscene
              or immoral purpose.
            </li>
            <li>
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          and us (including, but not limited to, any prior versions of the Terms
          of Service).
          <br />
      ...
      <section className="lg:mb-12 md:mb-12">
        ...
        <p className="text-[12px] lg:text-[16px] md:text-[16px]">
          ...
          you Services shall be governed by and construed by the laws of Delhi,
          (IN) India.
        </p>
      </section>
