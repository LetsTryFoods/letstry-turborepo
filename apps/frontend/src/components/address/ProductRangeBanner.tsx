    ...
    return (
        <section className="w-full pb-8 md:pb-10 mb-4 md:mb-6 rounded-lg overflow-hidden">
            <Link
                ...
                style={{
                    background: "linear-gradient(120deg, #005ea8 0%, #004d8c 55%, #003a6e 100%)",
                    minHeight: "140px",
                    textDecoration: "none",
                    borderRadius: "0px",
                }}
                ...
                {productImages.length > 0 && (
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                width: "40%",
                                background: "linear-gradient(to right, #004d8c 10%, transparent 100%)",
                            }}
                        />

                        {/* product images anchored to the bottom */}
                        <div className="absolute inset-0 flex items-end justify-center pb-0">
                            <div className="flex items-end" style={{ gap: "clamp(2px, 1vw, 8px)" }}>
