      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative animate-in fade-in zoom-in duration-200">
        ...
        <div className="p-6 md:p-8 text-center">
          <p className="text-gray-600 text-base md:text-lg mb-6 leading-relaxed">
            Orders placed from{" "}
            <span className="font-bold text-gray-900 border-b-2 border-yellow-400">
              April 14 onwards
            </span>{" "}
            are experiencing delays of approximately{" "}
            <span className="font-bold text-red-600">15–20 days</span> due to
            logistics issues.
            <br />
            <br />
