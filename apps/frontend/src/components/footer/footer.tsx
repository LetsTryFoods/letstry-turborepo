...
const EXPLORE_LINKS: Array<{ href: string; label: string }> = [
  ...
  { href: "/distribution-form", label: "Distributors & Corporate" }
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-8">
          <div className="col-span-2 md:col-span-1 flex flex-col items-start">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Healthy Indian snacks with no palm oil and no maida. Shipped
              across India from Delhi.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-gray-300 flex flex-col gap-2 text-sm">
              ...
              <Link
                href="mailto:ecom@earthcrust.co.in"
              ...
              <p className="mt-2">
                Export queries:{" "}
                <Link
                  href="mailto:export@earthcrust.co.in"
