                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {order.items.map((item, index) => (
                      <div
                        key={index}
                        className="flex flex-col xs:flex-row items-start xs:items-center gap-2 xs:gap-4 p-3 bg-gray-50 rounded-lg"
                      >
                        {item.image && (
                          <img
                            src={item.image}
                        ...
                        <div className="text-left xs:text-right w-full xs:w-auto">
                          ...
                          <p className="font-semibold text-gray-900">
                            {order.currency} {item.totalPrice || item.price}
                          </p>
                        </div>
                      </div>
                    ))}
                    ...
                    <div>
                      ...
                      <div className="text-xs sm:text-sm text-gray-600 space-y-2 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="flex justify-between">
                          <span>Amount:</span>
                          <span className="font-semibold text-gray-900">
                            {order.currency} {order.payment.amount}
                          </span>
                        </div>
