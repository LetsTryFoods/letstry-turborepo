...
export function BestsellerCarouselClient({
  initialProducts,
  ...
  useEffect(() => {
    ...
    if (!el || initialProducts.length === 0 || hasFiredViewListRef.current)
      return;
      ...
      >
        ...
        >
          ...
          <g className="ornament-sway" style={{ transformOrigin: "80px 10px" }}>
            ...
            />
            <path
              d="M80,120 L74,140 L80,155 L86,140 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
            <path
              d="M80,118 L76,113 L80,110 L84,113 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
          </g>
          ...
          <g
            ...
            style={{ transformOrigin: "200px 30px", animationDelay: "0.5s" }}
          >
            <line
              x1="200"
              y1="30"
            ...
            />
            <path
              d="M200,103 L195,117 L200,128 L205,117 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
            <path
              d="M200,101 L197,97 L200,94 L203,97 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
          </g>
          ...
          <g
            className="ornament-sway"
            style={{ transformOrigin: "340px 42px", animationDelay: "1s" }}
          >
            <line
              x1="340"
              y1="42"
            ...
            />
            <path
              d="M340,88 L336,98 L340,106 L344,98 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
            <path
              d="M340,86 L337,83 L340,80 L343,83 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
          </g>
          ...
          <g
            className="ornament-sway"
            style={{ transformOrigin: "1360px 10px", animationDelay: "0.3s" }}
          >
            <line
              x1="1360"
              y1="10"
            ...
            />
            <path
              d="M1360,120 L1354,140 L1360,155 L1366,140 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
            <path
              d="M1360,118 L1356,113 L1360,110 L1364,113 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
          </g>
          ...
          <g
            className="ornament-sway"
            style={{ transformOrigin: "1240px 30px", animationDelay: "0.8s" }}
          >
            <line
              x1="1240"
              y1="30"
            ...
            />
            <path
              d="M1240,103 L1235,117 L1240,128 L1245,117 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
            <path
              d="M1240,101 L1237,97 L1240,94 L1243,97 Z"
              fill="#C9A84C"
              opacity="0.9"
            />
          </g>
      ...
      <div className="relative z-20 px-4 sm:px-8 lg:px-16 pb-6 sm:pb-14">
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 0 0 1px rgba(201,168,76,0.3), 0 8px 40px rgba(0,0,0,0.35)",
          }}
        >
          <div
            className="rounded-2xl sm:rounded-3xl overflow-hidden"
            style={{
              background: "rgba(10, 60, 50, 0.45)",
          ...
          >
            ...
            >
              <div
                className="flex gap-3 sm:gap-4 md:gap-6 lg:gap-8 pb-2"
