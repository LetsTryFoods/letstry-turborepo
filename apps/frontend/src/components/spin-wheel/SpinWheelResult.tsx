    ...
    return (
      <div className="flex flex-col gap-4 w-full">
        ...
        <p className="text-gray-500 text-sm leading-relaxed">
          Oh no! You didn&apos;t win any prize this time, but don&apos;t give
          up! Spin the wheel again after this week for another chance to win
          amazing rewards. Good luck next time!
        </p>
        <Link
          href="/products"
          onClick={handleClose}
    ...
    <div className="flex flex-col gap-4 w-full">
      <div className="flex justify-center">
        ...
        >
          ...
          <path
            d="M16,14 Q140,2 264,14 L260,60 Q140,74 20,60 Z"
            fill="#e74c3c"
          />
          <path
            d="M16,14 Q140,2 264,14 L262,22 Q140,11 18,22 Z"
      ...
      <div>
        ...
        <p className="text-gray-500 text-sm leading-relaxed mt-1">
          ...
          <span className="font-bold text-gray-800">{result.label}</span> on
          your next purchase!
        </p>
      </div>
      ...
      <p className="text-center text-gray-400 text-xs">
        Hurry! Offer valid for the next 54 hours only.
      </p>
