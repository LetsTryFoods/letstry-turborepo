...
export function OrderDetailsDialog({
  ...
  const { order: fullOrder, loading: fetchingOrder } = useOrderById(
    summaryOrder?.orderId || "",
  );
            ...
            <div className="flex gap-2">
              {order.shipment?.dtdcAwbNumber && (
                ...
                >
                  ...
                  {isDownloadingAll || downloadingLabel
                    ? "Downloading..."
                    : "Download All"}
                </Button>
              )}
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span>
                        ...
                        {order.deliveryCharge
                          ? Number(order.deliveryCharge).toLocaleString()
                          : "0"}
                      </span>
                    </div>
                  )}
