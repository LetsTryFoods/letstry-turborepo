...
export default function QrAnalyticsPage() {
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className="rounded-xl border p-5 animate-pulse bg-white"
            >
  ...
  const totals = analytics?.totalOSSplit || {
    android: 0,
    ios: 0,
    windows: 0,
    macOS: 0,
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-gray-100 pb-5">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Real-time deep-link scan routing analytics and device engagement
            logs.
          </p>
        </div>
        <button
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-5 shadow-sm hover:shadow transition-shadow">
          ...
          <p className="text-3xl font-black text-gray-900 mt-2">{totals.ios}</p>
          <div className="mt-2 text-xs text-gray-500">
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <div className="space-y-4">
          {[
            ...
            {
              label: "Mac OS Systems",
              count: totals.macOS,
              color: "bg-indigo-600",
            },
            {
              label: "Other/Web Fallbacks",
              count: totals.other,
              color: "bg-amber-500",
            },
          ].map((item) => {
            ...
            <tbody className="divide-y divide-gray-100 text-xs">
              {!analytics?.recentScans || analytics.recentScans.length === 0 ? (
                <tr>
                  ...
                  >
                    No scan footprints recorded yet. Scan the QR live to
                    generate records.
                  </td>
                </tr>
              ) : (
                analytics.recentScans.map((scan, idx) => {
                  const lastTimestamp =
                    scan.dateTime?.[scan.dateTime.length - 1] || "N/A";
                      ...
                      <td className="p-4 font-medium text-gray-900 max-w-[200px] truncate">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <div
                              className="text-[11px] text-gray-400 font-normal truncate"
