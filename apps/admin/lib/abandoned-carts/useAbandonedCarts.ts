    ...
    items: [
      {
        product: {
          ...
          image:
            "https://www.letstryfoods.com/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fdxhwn7p8r%2Fimage%2Fupload%2Fv1731390694%2Fqkwvvb5ldznpyknlhhvt.png&w=640&q=75",
        },
        variant: "500g",
        quantity: 2,
        price: 299,
...
export const getAbandonedCartStats = (carts: AbandonedCart[]) => {
  ...
  return {
    ...
    last24Hours: carts.filter((c) => new Date(c.lastActivity) > oneDayAgo)
      .length,
    last3Days: carts.filter((c) => new Date(c.lastActivity) > threeDaysAgo)
      .length,
    last7Days: carts.filter((c) => new Date(c.lastActivity) > sevenDaysAgo)
      .length,
    averageCartValue: Math.round(
      carts.reduce((sum, cart) => sum + cart.subtotal, 0) / carts.length,
    ),
...
export const whatsAppTemplates = [
  {
    ...
    name: "Cart Reminder",
    message:
      "Hi {{name}}, you left some delicious pickles in your cart worth ₹{{value}}! Complete your order now and enjoy authentic homemade taste. Shop now: https://www.letstryfoods.com/cart",
  },
  {
    id: "discount",
    name: "Special Discount",
    message:
      "Hi {{name}}, we noticed items worth ₹{{value}} in your cart! Use code COMEBACK10 for 10% off. Limited time offer! Shop: https://www.letstryfoods.com/cart",
  },
  {
    id: "urgency",
    name: "Limited Stock",
    message:
      "Hi {{name}}, hurry! Items in your cart (₹{{value}}) are selling fast. Complete your order before they're gone! Shop: https://www.letstryfoods.com/cart",
  },
  {
    id: "free_delivery",
    name: "Free Delivery",
    message:
      "Hi {{name}}, good news! Get FREE delivery on your cart worth ₹{{value}}. Complete your order today! Shop: https://www.letstryfoods.com/cart",
  },
];
...
export const smsTemplates = [
  {
    ...
    name: "Cart Reminder",
    message:
      "Hi {{name}}, your cart (₹{{value}}) is waiting! Complete your order at LetsTry Foods. Shop: letstryfoods.com/cart",
  },
  {
    id: "discount",
    name: "Special Discount",
    message:
      "Hi {{name}}, get 10% off on your cart (₹{{value}})! Use code COMEBACK10. Shop: letstryfoods.com/cart",
  },
  {
    id: "urgency",
    name: "Limited Stock",
    message:
      "Hi {{name}}, items in your cart (₹{{value}}) are selling fast! Order now: letstryfoods.com/cart",
  },
  {
    id: "free_delivery",
    name: "Free Delivery",
    message:
      "Hi {{name}}, FREE delivery on your cart (₹{{value}})! Complete order: letstryfoods.com/cart",
  },
];
