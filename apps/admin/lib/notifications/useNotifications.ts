...
export const notificationTemplates: NotificationTemplate[] = [
  {
    ...
    message:
      "Thank you for joining us! Enjoy authentic homemade pickles delivered to your doorstep. Use code WELCOME10 for 10% off your first order!",
    type: "PUSH",
  },
  {
    _id: "temp2",
    ...
    message:
      "Your delicious pickles are waiting! Complete your order now and enjoy free delivery on orders above ₹499.",
    type: "PUSH",
  },
  {
    _id: "temp3",
    ...
    message:
      "We hope you enjoy your authentic pickles! Don't forget to leave a review and share your experience with us.",
    type: "PUSH",
  },
  {
    _id: "temp4",
    ...
    message:
      "Introducing our new [Product Name]! Made with traditional recipes and fresh ingredients. Order now!",
    type: "PUSH",
  },
  {
    _id: "temp5",
    ...
    message:
      "Celebrate with LetsTry Foods! Get up to 30% off on all pickles. Limited time offer. Shop now!",
    type: "EMAIL",
  },
  {
    _id: "temp6",
    ...
    message:
      "It's been a while since your last order. We miss you! Here's 15% off on your next purchase.",
    type: "SMS",
  },
];
...
export const dummyNotifications: Notification[] = [
  {
    ...
    message:
      "Celebrate Diwali with our special pickle hampers! Get 25% off on combo packs. Use code DIWALI25. Valid till Nov 15th.",
    type: "PUSH",
    status: "SENT",
    audience: "ALL",
    targetCount: 1250,
  ...
  },
  {
    ...
    message:
      "Introducing our Premium Rajasthani Aam ka Achar! Made with raw mangoes and traditional spices. Try now!",
    type: "EMAIL",
    status: "SENT",
  ...
  },
  {
    ...
    message:
      "Flash Sale Alert! Get 20% off on all pickles this weekend. No code needed. Auto-applied at checkout!",
    type: "PUSH",
    status: "SCHEDULED",
    audience: "ALL",
    targetCount: 1320,
  ...
  },
  {
    ...
    message:
      "Your cart is waiting! You have items worth ₹599 in your cart. Complete your order now and get free delivery!",
    type: "SMS",
    status: "SENT",
    audience: "CUSTOM",
    targetCount: 45,
  ...
  },
  {
    ...
    title: "We Miss You! 💚",
    message:
      "It's been 30 days since your last order. Come back and enjoy 15% off with code MISSYOU15!",
    type: "EMAIL",
    status: "SENT",
  ...
  },
  {
    ...
    message:
      "Thank you for your order #LTF-2024-XXX! Your delicious pickles are being prepared and will be shipped soon.",
    type: "EMAIL",
    status: "DRAFT",
    audience: "CUSTOM",
    targetCount: 0,
  ...
  },
  {
    ...
    message:
      "Merry Christmas from LetsTry Foods! Gift your loved ones the taste of tradition. Special hampers available now!",
    type: "PUSH",
    status: "SCHEDULED",
    audience: "ALL",
    targetCount: 1320,
  ...
  },
  {
    ...
    message:
      "Welcome to the LetsTry Foods family! Enjoy 10% off on your first order with code WELCOME10.",
    type: "EMAIL",
    status: "FAILED",
...
export const getNotificationStats = (notifications: Notification[]) => {
  ...
  const avgOpenRate =
    sentNotifications.length > 0
      ? sentNotifications.reduce((sum, n) => sum + (n.openRate || 0), 0) /
        sentNotifications.filter((n) => n.openRate).length
      : 0;
  const avgClickRate =
    sentNotifications.length > 0
      ? sentNotifications.reduce((sum, n) => sum + (n.clickRate || 0), 0) /
        sentNotifications.filter((n) => n.clickRate).length
      : 0;
