...
export const useCreateCategoryLandingPage = () => {
  const [mutate, { loading, error }] = useMutation(CREATE_CATEGORY_LANDING_PAGE, {
...
export const useUpdateCategoryLandingPage = () => {
  const [mutate, { loading, error }] = useMutation(UPDATE_CATEGORY_LANDING_PAGE, {
    refetchQueries: [{ query: GET_CATEGORY_LANDING_PAGES }],
  })
  return { mutate, loading, error }
}
...
export const useUpdateCategoryLandingPageActive = () => {
  const [mutate, { loading, error }] = useMutation(UPDATE_CATEGORY_LANDING_PAGE_ACTIVE, {
    refetchQueries: [{ query: GET_CATEGORY_LANDING_PAGES }],
  })
  return { mutate, loading, error }
}
...
export const useDeleteCategoryLandingPage = () => {
  const [mutate, { loading, error }] = useMutation(DELETE_CATEGORY_LANDING_PAGE, {
    refetchQueries: [{ query: GET_CATEGORY_LANDING_PAGES }],
  })
  return { mutate, loading, error }
}
